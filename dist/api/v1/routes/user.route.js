...
const controllers = __importStar(require("../controllers/user.controller"));
const validates = __importStar(require("../validates/user.validate"));
...
router.get("/detail", auth_middleware_1.requireAuth, controllers.detail);
router.get("/list", auth_middleware_1.requireAuth, controllers.list);
